...
with st.sidebar.expander("Model Configuration", expanded=True):  # Expanded by default
    hidden_size = st.slider(
        ...
        max_value=256, 
        step=16, 
        value=hidden_size,  # Use the globally initialized variable as the default
    ...
    learning_rate = st.slider(
        ...
        max_value=0.1, 
        step=0.001, 
        value=learning_rate,  # Use the globally initialized variable as the default
    ...
    curiosity = st.slider(
        ...
        max_value=2.0, 
        step=0.1, 
        value=curiosity,  # Use the globally initialized variable as the default
...
# Sidebar for Learning Rate Scheduler
